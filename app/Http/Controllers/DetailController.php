...
class DetailController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.detail.index',compact('list'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.detail.form',compact('specie','location','category'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.detail.form', compact( 'specie', 'category', 'location','detail'));
    }
